...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in DroneAid, creating a new issue in the `Call-for-Code/DroneAid`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Call-for-Code/DroneAid` in a concrete and reviewable manner.
...
When opening a new issue in the `Call-for-Code/DroneAid` issue tracker, please provide as much
